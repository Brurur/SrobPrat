...
# fungsi iqr 
hitung_iqr <- function(data_kolom, nama_variabel) {
  # Q1, Q3, dan IQR
...
data_2020$pdrb_perkapita
for(i in 1:ncol(data_2020)) {
  boxplot(data_2020[[i]], main = colnames(data_2020)[i], col = "green")
}
...
for(i in 1:ncol(data_2021)) {
  boxplot(data_2021[[i]], main=colnames(data_2021)[i], col="red")
}
...
data_2022 <- data %>% filter(tahun == 2022)  %>% 
  select(pdrb_perkapita, kemiskinan, pengangguran, ipm, 
         harapan_hidup, rata_lama_sekolah, akses_internet, jalan_baik, air_bersih)
par(mfrow = c(3, 3), mar = c(2, 2, 3, 1), oma = c(0, 0, 4, 0))
for(i in 1:ncol(data_2022)) {
  boxplot(data_2022[[i]], main=colnames(data_2022)[i], col="purple")
}
...
data_2023 <- data %>% filter(tahun == 2023)  %>% 
  select(pdrb_perkapita, kemiskinan, pengangguran, ipm, 
         harapan_hidup, rata_lama_sekolah, akses_internet, jalan_baik, air_bersih)
par(mfrow = c(3, 3), mar = c(2, 2, 3, 1), oma = c(0, 0, 4, 0))
for(i in 1:ncol(data_2023)) {
  boxplot(data_2023[[i]], main=colnames(data_2023)[i], col="yellow")
}
...
data_2024 <- data %>% filter(tahun == 2024)  %>% 
  select(pdrb_perkapita, kemiskinan, pengangguran, ipm, 
         harapan_hidup, rata_lama_sekolah, akses_internet, jalan_baik, air_bersih)
par(mfrow = c(3, 3), mar = c(2, 2, 3, 1), oma = c(0, 0, 4, 0))
for(i in 1:ncol(data_2024)) {
  boxplot(data_2024[[i]], main=colnames(data_2024)[i], col="skyblue")
}
